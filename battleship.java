...
public class battleship {
	...
	// main method
	{
		...
		while (choice == 'Y' || choice == 'y') {
			...
			Ship5();
			MonsterPlacement();
			while (ship1 == true || ship2 == true || ship3 == true || ship4 == true || ship5 == true)
			...
			// provides a choice to restart the game when all ships have sunk
			{
	...
	// places submarine
	{
		...
		while (size == 3) {
			...
			int y = rand.nextInt(10);
			if ((x >= 0) && (x + size < 10) && (board[x][x + size] != 2) && (board[x][x + size] != 15)
					&& (board[x][x + size] != 14) && (board[x][x + size] != 13)) {
				for (int i = 0; i < size; i++) {
					if ((board[x][x + i] == 2) || (board[x][x + size] == 15) || (board[x][x + size] != 14)
							|| (board[x][x + size] != 13))
						;
				...
				size--;
					...
					&& (board[y + size][y] != 14) && (board[y + size][y] != 13)) {
				for (int i = 0; i < size; i++) {
					if ((board[y + i][y] == 2) || (board[y + size][y] == 15) || (board[y + size][y] == 14)
							|| (board[y + size][y] == 14) || (board[y + size][y] == 13))
						;
	...
	// places patrol boat
	{
		...
		while (size == 2) {
			...
			int y = rand.nextInt(10);
			if ((x >= 0) && (x + size < 10) && (board[x][x + size] != 2) && (board[x][x + size] != 15)
					&& (board[x][x + size] != 14) && (board[x][x + size] != 13) && (board[x][x + size] != 23)) {
				for (int i = 0; i < size; i++) {
					if ((board[x][x + i] == 2) || (board[x][x + size] == 15) || (board[x][x + size] != 14)
							|| (board[x][x + size] != 13) || (board[x][x + size] != 23))
						;
					continue;
				}
				for (int i = 0; i < size; i++) {
				...
				size--;
					...
					&& (board[y + size][y] != 14) && (board[y + size][y] != 13) && (board[y + size][y] != 23)) {
				for (int i = 0; i < size; i++) {
					if ((board[y + i][y] == 2) || (board[y + size][y] == 15) || (board[y + size][y] == 14)
							|| (board[y + size][y] == 14) || (board[y + size][y] == 13) || (board[y + size][y] == 23))
						;
	...
	// allows the user to "shoot"
	{
		...
		if (board[rowshot][columnshot] == 0) {
			...
			points--;
			flag++;
		} else if (board[rowshot][columnshot] == 15 || board[rowshot][columnshot] == 14
				|| board[rowshot][columnshot] == 13 || board[rowshot][columnshot] == 23
				|| board[rowshot][columnshot] == 12) {
	...
	// checks whether ships have been sunk or not
	{
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
				if (board[i][j] == 15) {
	...
	public static void MonsterPlacement() throws IOException
	// places the two monsters
	{
		int krakenawaken = 0;
		int cetusawaken = 0;
		Random rand = new Random();
		...
		while (krakenawaken == 0) {
			if (board[krakenrow][krakencolumn] != 15 || board[krakenrow][krakencolumn] != 14
					|| board[krakenrow][krakencolumn] != 13 || board[krakenrow][krakencolumn] != 23
					|| board[krakenrow][krakencolumn] != 12) {
		...
		while (cetusawaken == 0) {
			if (board[cetusrow][cetuscolumn] != 15 || board[cetusrow][cetuscolumn] != 14
					|| board[cetusrow][cetuscolumn] != 13 || board[cetusrow][cetuscolumn] != 23
					|| board[cetusrow][cetuscolumn] != 12 || board[cetusrow][cetuscolumn] != 3) {
	...
	public static void Cetus()
	// executes the movement of ships if cetus is awakened
	{
		Reset();
		if (ship1 == true) {
			Random rand = new Random();
